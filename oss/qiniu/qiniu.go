...
func (client Client) Get(ctx context.Context, path string) (file *os.File, err error) {
	...
	if file, err = os.CreateTemp("/tmp", "qiniu"); err == nil {
...
func (client Client) GetStream(ctx context.Context, path string) (io.ReadCloser, error) {
	purl, err := client.GetURL(ctx, path)
	if err != nil {
		return nil, err
	}
...
func (client Client) Put(ctx context.Context, urlPath string, reader io.Reader) (r *oss.Object, err error) {
...
func (client Client) List(ctx context.Context, path string) (objects []*oss.Object, err error) {
...
func (client Client) GetURL(ctx context.Context, path string) (url string, err error) {
	...
	url = storage.MakePublicURL(client.GetEndpoint(ctx), key)
