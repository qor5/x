...
type ServerConfig struct {
	...
	PathPrefix        string         `confx:"pathPrefix" usage:"Path prefix for all handlers. Will be normalized to start with '/' and not end with '/' (except for root path '/'). Example: 'api/v1' or '/api/v1/' both become '/api/v1'"`
